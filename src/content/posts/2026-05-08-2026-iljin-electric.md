...
draft: false
loop:
  prior: "일진전기: 수주 고성장 이후, 이익 체력은 어디까지 지속되나"
  result: "일진전기의 2026년 관전 포인트는 북미 초고압 변압기 수주의 매출 인식 전환 속도와 제품 믹스 개선의 동시성이다."
  score: "pending"
  note: "당일 기록. 이후 세션으로 채점하지 않음"
  next: "다만 대형 프로젝트 비중 확대 구간에서는 납기·원가·운전자본 변동성이 동반되기 때문에, 수주 규모보다 마진의 질과 현금흐름 안정성을 함께 점검해야 한다."
sources:
  - id: "src-1"
    tier: 1
    type: "filing"
...
> **CALL.** 북미 초고압 변압기 수주는 확인됐지만, 2026년 재평가의 본질은 수주액이 아니라 매출 인식·마진·현금전환이 함께 증명되는지다.
...
1. **분기별 대형 수주의 매출 인식률**
2. **고사양 믹스가 영업이익률을 지키는지**
3. **운전자본 증가 없이 현금이 회수되는지**

...
> **CALL.** AI 데이터센터의 병목은 GPU가 아니라 송전망·변압기·HVDC 케이블·가스터빈으로 이어지는 전력 공급사슬이며, 정책 발표보다 실제 연계·납품 속도가 수혜의 질을 가른다.
...
1. **송전 연계와 변전소 인허가의 실제 진척**
2. **변압기·HVDC·가스터빈의 리드타임과 수주 조건**
3. **빅테크 CAPEX가 계약과 가동으로 전환되는 속도**

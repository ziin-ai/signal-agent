...
`post-from-sources` **ziin analysis engine** 순서 고정. 섹션 제목은 살짝 바꿔도 되고, 순서는 바꾸지 않는다.

```markdown
## 오늘의 결론

{2~5문장: 질문이 무엇인지 + 바로 답. 리서치 나열 금지}
...
{데일리 2~3건 synthesize — 쉬운 말 인과, {{cite:src-x}}}

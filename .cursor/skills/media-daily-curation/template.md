...
- `channel`: `federal-reserve` | `bok-official` | `bloomberg-tv` | `cnbc-intl` | `reuters-news` | `wsj-video` | `ft-video` | `yahoo-finance` | `hankyung-tv` | `yonhap-infomax` | `sampro-tv` | `syuka-world` | `talent-invest` | `sosumonkey` | `mtn`
